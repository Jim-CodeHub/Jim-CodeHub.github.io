...
1.1
关于版本控制
版本控制，是记录文件内容变化，并提供增、删、改、查和回溯等功能的系统
版本控制系统（VCS）
...
分布式VCS还有许多新的优势
1.2Git简史
1991年~2002年，在Linux内核开发过程中，绝大多数的内核维护工作都花在了提交补丁和保存归档的繁琐事物上，到2002年项目组开始使用BitKeeper的VCS来维护。
到了2005年，开发BitKeeper的公司同Linux内核开源社区合作关系结束，自此开始收费，这迫使Linux torvalds 基于BitKeeper的使用教训，开发出了自己的VCS，并对其定制了若干目标：
①速度
②简单的设计
③对非线性开发模式的强力支持（允许成千上万个并行开发分支）
④完全分布式
⑤有能力管理类似Linux内核一样的超大规模项目（速度和数据量）
子2005年以来，git日渐成熟完善，并应用到无数的项目当中。
1.3GIT基础
git对待数据像“快照流”，
